...
import com.hocs.server.saas_platform.facade.GitHubFacade;
...
public class GitHubController {
	...
	public String home(Model model, @AuthenticationPrincipal OAuth2User oauth2User) {
		if (oauth2User != null) {
			...
			// 사용자 저장소 가져오기
			List<Map<String, Object>> repos = gitHubFacade.getUserRepos(accessToken);
	...
	public String githubCallback(@AuthenticationPrincipal OAuth2AuthenticationToken authentication) {
		gitHubFacade.gitPrivateClone(authentication);
